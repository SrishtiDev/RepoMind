 ...
 */
function extractFileData(filepath, tree) {
    const data = {
        filepath,
        imports: [],
        functions: [],
...
function walkNode(node, data, currentCaller) {
    ...
    if (node.type === "import_statement") {
        ...
        if (heritage) {
            const identifier = heritage.children.find((c) => c.type === "identifier" ||
